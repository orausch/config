...
(with-eval-after-load 'evil-maps (define-key evil-motion-state-map (kbd "<C-i>")
				   'evil-jump-forward))
...
(use-package 
  lsp-ivy 
  :load-path "~/repos/lsp-ivy" 
  :after lsp 
  :commands lsp-ivy-workspace-symbol 
  :config (setq lsp-ivy-show-symbol-kind t) 
...
(custom-set-variables
 ...
 '(ansi-color-names-vector ["#1e1e1e" "#D16969" "#579C4C" "#D7BA7D" "#339CDB" "#C586C0" "#85DDFF"
			    "#d4d4d4"]) 
 '(clang-format-style "google") 
 '(custom-safe-themes (quote ("777a3a89c0b7436e37f6fa8f350cbbff80bcc1255f0c16ab7c1e82041b06fccd"
 ...
 '(lsp-python-ms-python-executable-cmd "/home/orausch/.local/opt/miniconda3/envs/onnx/bin/python") 
 '(lua-indent-level 4) 
 '(menu-bar-mode nil) 
 '(objed-cursor-color "#D16969") 
 '(org-adapt-indentation nil) 
 '(org-capture-templates (quote (("i" "Inbox" entry (file "~/org/inbox.org") "* TODO") 
				 ("m" "Meeting Notes- Bachelor's Thesis" entry (function
										org-journal-find-location)
...
%i%?") 
				 ("l" "Link entry" entry (file "~/org/inbox.org") "* %a")))) 
 '(org-clock-out-when-done (quote ("DONE" "WAITING"))) 
 '(org-refile-targets (quote (("~/org/tasks.org" :maxlevel . 1)))) 
 '(org-roam-directory "~/org/" t) 
 '(org-src-tab-acts-natively t) 
 '(package-selected-packages (quote (elisp-format org htmlize yapfify yaml-mode use-package
						  treemacs-evil ripgrep realgud rainbow-delimiters
						  pyvenv protobuf-mode projectile org-journal
						  magit-popup lua-mode lsp-ui lsp-treemacs
						  lsp-python-ms highlight-indentation ghub flycheck
						  find-file-in-project evil-surround evil-org
						  evil-magit evil-leader evil-commentary
						  evil-collection doom-themes doom-modeline
						  dired-subtree counsel conda company-quickhelp
						  company-lsp company-irony clang-format+ bind-map
						  benchmark-init all-the-icons-ivy
						  all-the-icons-dired))) 
 '(pdf-view-midnight-colors (cons "#d4d4d4" "#1e1e1e")) 
 '(rustic-ansi-faces ["#1e1e1e" "#D16969" "#579C4C" "#D7BA7D" "#339CDB" "#C586C0" "#85DDFF"
		      "#d4d4d4"]) 
 '(show-paren-mode t) 
 '(tool-bar-mode nil) 
 '(vc-annotate-background "#1e1e1e") 
 '(vc-annotate-color-map (list (cons 20 "#579C4C") 
			       (cons 40 "#81a65c") 
			       (cons 60 "#acb06c") 
			       (cons 80 "#D7BA7D") 
			       (cons 100 "#d8ab79") 
