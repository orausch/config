...
(let* ((class '((class color) (min-colors 89)))
  ...
  (custom-theme-set-faces
   ...
   `(font-lock-variable-name-face ((,class (:foreground ,foreground :slant italic :weight bold))))

   `(font-lock-type-face ((,class (:foreground ,function-and-class :slant italic :weight bold))))
   `(font-lock-function-name-face ((,class (:foreground ,function-and-class :weight bold))))
